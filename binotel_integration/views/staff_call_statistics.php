...
<div class="panel_s">
    ...
    $.ajax({
        url: '<?php echo admin_url('binotel_integration/get_filtered_calls_for_staff'); ?>',
        type: 'POST',
        data: $.param(data),
    ...
    if (selectedNumber) {
       ...
       <?php $CI->load->view('call_statistics_partial_view_staff', ['call_statistics' => $call_statistics]); ?>
        </div>
    </div>
</div>
