...
<div class="form-group">
    <label for="binotel_openai_transcribe_model"><?php echo _l('OpenAI модель для транскрибації'); ?></label>
    <input type="text" id="binotel_openai_transcribe_model" name="settings[binotel_openai_transcribe_model]" class="form-control"
           value="<?php echo get_option('binotel_openai_transcribe_model') ?: 'gpt-4o-mini-transcribe'; ?>">
    <small class="text-muted">Приклад: <code>gpt-4o-mini-transcribe</code> або <code>whisper-1</code>.</small>
</div>
